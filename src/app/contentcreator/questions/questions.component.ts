...
export class QuestionsComponent implements OnInit {
  ...
  constructor(public service: MainService, private _fb: FormBuilder, private router: Router) {
   }
  ...
  nextQuestion(): void {
    const correctAnswerA = this.answers.controls[parseInt(this.questionsGroup.get('correctAnswer').value)].value;
